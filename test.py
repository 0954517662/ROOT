                    ...
                    if to not in settings["botMute"] and to not in settings["botOff"]:
                        ...
                        if cmd == "memegen":
                           ...
                           for target in targets:
                            ...
                            client.sendMessage(to, contentMetadata={'countryCode': 'ID', 'i-installUrl': 'line://ti/p/~max_pv', 'a-packageName': 'com.spotify.music', 'linkUri': 'line://ti/p/~max_pv', 'subText': 'Just Newbie :v', 'a-installUrl': 'line://ti/p/~max_pv', 'type': 'mt', 'previewUrl': image, 'a-linkUri': 'line://ti/p/~max_pv', 'text': name, 'id': 'mt000000000a6b79f9', 'i-linkUri': 'line://ti/p/~max_pv'}, contentType=19)
                        elif cmd == "mymid":
